...
public class AccountInterestRateComparator implements Comparator<Account> {

    @Override
    public int compare(Account a1, Account a2) {

        if (a1.interestRate.compareTo(a2.interestRate) < 0) {
            return 1;
        } else if (a1.interestRate.compareTo(a2.interestRate) > 0) {
            return -1;
        }
